...
for i in range(10):
    ...
    model_car.learn(total_timesteps=50_000,tb_log_name=f"05_mln_g09_cont_try_{i}")
# ----------------------------
...
for i in range(10):
    ...
    model_car.learn(total_timesteps=50_000,tb_log_name=f"05_mln_g99_cont_try_{i}")
# ----------------------------
...
for i in range(10):
    ...
    model_car.learn(total_timesteps=50_000,tb_log_name=f"05_mln_g999_cont_try_{i}")
# ----------------------------
